...
+ import { firestore, ensureAnonLogin } from '../../component/auth'; // ← ปรับ path ให้ตรงกับที่คุณวางไฟล์จริง
  ...
  const handleSaveAndNext = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        // ใส่เมตาดาต้าเพิ่มเติมได้ เช่น sessionId, route, device, ฯลฯ
      };

      // เก็บไว้ในคอลเลกชันชื่อที่คุณต้องการ เช่น 'befast_histories'
      await addDoc(collection(db, 'befast_histories'), payload);
