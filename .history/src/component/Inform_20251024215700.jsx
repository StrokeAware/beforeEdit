 ...
 const assessmentbtn = [
  ...
  return (
    <div>
      ...
      {/* BANNER */}
       <div className="banner1-1 d-flex">
        <div className="container">
          <div className="row justify-content-center align-items-center">
            {/* กล่องข้อความ 2 บรรทัด */}
            <div className="col-12 col-lg-9 text-center d-flex flex-column justify-content-center">
              <h2
            ...
            {/* ปุ่มขวา */}
            <div className="col-12 col-lg-3 d-flex justify-content-lg-end justify-content-center mt-4 mt-lg-0">
              <button
                type="button"
                className="btn rounded-pill fw-bold border-0 shadow px-4 py-2"
                style={{
