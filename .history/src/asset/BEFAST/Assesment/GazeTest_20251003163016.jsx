    ...
    <div className="container">
      ...
      {summary && (
        <div className="result">
          <div className="result3"> Center: {summary.center.toFixed(2)} px</div>
          <div className="result3"> {t("lefteye1")}&nbsp;&nbsp;: {summary.left.toFixed(2)} px</div>
          <div className="result3"> {t("righteye1")}&nbsp;&nbsp;: {summary.right.toFixed(2)} px</div>
