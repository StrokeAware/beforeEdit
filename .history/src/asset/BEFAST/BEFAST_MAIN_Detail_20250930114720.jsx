...
export function BEFAST_MAIN_Detail() {
  ...
  const left  = { width: "clamp(25rem, 30vw, 35rem)" ,backgroundColor: "#ff0000ff", };
  ...
  const imgStyle = { display: 'block', width: "clamp(10rem , 20vw, 40rem)", height: "clamp(10rem , 18vw, 40rem)", marginTop: '7vw', marginLeft:"10vw"};
