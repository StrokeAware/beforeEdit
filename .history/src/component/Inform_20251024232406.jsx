        ...
        <div className="row flex-grow-1 w-100 align-items-center">
          ...
          <div className="col-12 col-lg-8 d-flex flex-column justify-content-center">
            ...
            <p
              ...
              style={{ fontSize: "clamp(0.9rem, 1.3vw, 1.1rem)", color: "#333" }}
            >
          ...
          {/* ฝั่งขวา */}
          <div className="col-12 col-lg-4 text-lg-end d-flex flex-column justify-content-center" style={{ backfaceVisibilitycolor: "#166989", fontSize: "5vw" }}>
            <h3
              className="fw-bold"
              style={{ color: "#166989", fontSize: "5vw" }}
            >
              STROKE SIGHT
            </h3>
