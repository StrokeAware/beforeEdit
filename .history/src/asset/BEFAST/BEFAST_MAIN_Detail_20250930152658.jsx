...
export function BEFAST_MAIN_Detail() {
  ...
  const imgStyle = { display: 'block', width: "clamp(5rem, 20vw, 40rem)", height: "clamp( rem, 18vw, 40rem)", margintop:"marginLeft: "4vw", position: "fixed",backgroundColor: "#ff0000ff",display:"flex" };
