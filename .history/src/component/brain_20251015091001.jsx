...
const Brain = () => {
  ...
  useEffect(() => {
    ...
    const onClick = (event) => {
      ...
      const intersects = raycaster.intersectObjects(brainGroupRef.current.children, true);
  ...
  useEffect(() => {
    ...
    const normalizedPos = (slicePosition - 50) / 50; // -1 .. 1
        ...
        <div className="p-6 space-y-6">
          ...
          {modelLoaded && (
            <>
              ...
              {/* Search */}
              <div>
                <label className="block text-xs font-semibold text-gray-500 uppercase mb-2">Find area in the brain</label>
                <input
                  type="text"
        ...
        {modelLoaded && (
          <div className="absolute top-6 right-6 bg-white/95 backdrop-blur rounded-xl shadow-2xl p-5 max-w-xs">
            ...
            <div className="space-y-2 text-xs text-gray-600">
              ...
              <p>
                <strong>Select:</strong> Click on regions
              </p>
              <p>
                <strong>Slice:</strong> Use sidebar slider
              </p>
            </div>
          </div>
        )}
