    ...
    <div>
      ...
      <div className="banner1-1">
        <div className="banner-content">
          <div className="infor1-firstpic">
            แพลตฟอร์มคัดกรองโรคหลอดเลือดสมองนอกโรงพยาบาลแบบเชิงรุก ด้วยเทคนิค{" "}
            <span style={{ fontWeight: "bold" }}>ASIS</span>
          </div>
          <div className="infor3-firstpic">
            StrokeSight: Prehospital Stroke Screening Platform using novel Acute Stroke Integrated Score
          </div>
          <div className="Start2" onClick={() => navigate("/PatientDetail")}>
      ...
      <div className="banner2">
        <div className="Boxofpic">
          <div className="pic balanceinthebox">
            <img src={balancepic} alt="การทรงตัว" />
          </div>
          <div className="pic eyeinthebox">
            <img src={eyepic} alt="สายตา" />
          </div>
          <div className="pic faceinthebox">
            <img src={facepic} alt="ใบหน้า" />
          </div>
          <div className="pic arminthebox">
            <img src={armpic} alt="กล้ามเนื้ออ่อนแรง" />
          </div>
          <div className="pic speechinthebox">
            <img src={speechpic} alt="การพูด" />
          </div>
          <div className="pic timeinthebox">
      ...
      <div className="banner3">
        ...
        <div className="footer-right">
          ...
          <button onClick={() => navigate("/About")} className="aboutus-btn">{t("developer")}</button>
          <div className="footertext7">
            <span>KEY PARTNER</span><br />
            <img src={prcANDnu} className="footerpic" alt="partners" />
          </div>
        </div>
      </div>

      <Link to="https://telemedoa-nihss-apps-projects.vercel.app/">ไปหน้าห้องใหม่</Link>
      <Link to="/Homepage">Go HomePage</Link>
