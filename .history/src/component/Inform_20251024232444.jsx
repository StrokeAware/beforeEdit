    ...
    <div>
      ...
      >
        <div className="row flex-grow-1 w-100 align-items-center">
          ...
          {/* ฝั่งขวา */}
          <div className="col-12 col-lg-4 text-lg-end d-flex flex-column justify-content-center" style={{ background: "#00b7ffff", fontSize: "5vw" }}>
            <h3
              className="fw-bold"
              style={{ color: "#166989", fontSize: "4.7vw" }}
            >
              STROKE SIGHT
            </h3>
