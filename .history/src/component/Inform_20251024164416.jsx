  ...
  return (
    <div>
      ...
      <div className="banner1-1">
        <div
          className="banner-content d-flex align-items-center flex-direction-column"
          style={{ width: "100%" }}
        >
          ...
          <button
            type="button"
            className="btn d-flex justify-content-center rounded-pill border-0 fw-bold ms-3"
            style={{
