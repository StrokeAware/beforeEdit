      ...
      <div className="banner1-1">
        <div className="banner-content">
          <div className="bannerforcon">    
            ...
            <button
              type="button"
              className="btn d-flex align-items-center justify-content-end rounded-pill border-0"
              style={{
                backgroundColor: "#1e90ff", // ฟ้าแบบในภาพ
                color: "#fff",
                fontWeight: "700",
                fontSize: "clamp(0.8rem, 1vw, 1.2rem)", // 👈 ลดขนาดให้พอดี
