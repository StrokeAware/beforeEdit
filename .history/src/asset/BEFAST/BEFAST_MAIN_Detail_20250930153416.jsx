...
export function BEFAST_MAIN_Detail() {
  ...
  const imgStyle = { display: 'block', width: "clamp(5rem, 20vw, 40rem)", height: "clamp( 5rem, 18vw, 30rem)", marginTop:"clamp(-10rem, 15vw, 20rem)",marginLeft: "clamp(6rem, 3vw, 6rem)", position: "fixed",display:"flex" };
