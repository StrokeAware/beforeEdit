...
export function BEFAST_MAIN_Detail() {
  ...
  const questions = [
    ...
    { id: 'question2', text: t("questions.question1") },
    { id: 'question3', text: t("questions.question1") },
    { id: 'question4', text: t("questions.question1") },
    { id: 'question5', text: t("questions.question1") },
    { id: 'question6', text: t("questions.question1") },
  ];
