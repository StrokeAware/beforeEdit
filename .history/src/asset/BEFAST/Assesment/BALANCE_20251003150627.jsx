   ...
   <div style={{ textAlign: "center", marginTop: "15px" }}>
    {testPhase === "standby" && !isInCenter && (
      <>
        ...
        <p style={{ fontSize: 24, color: "#b22", fontFamily: "Prompt" }}>
    ...
    {testPhase === "counting" && countdown !== true && (
      <>
        <p style={{ fontSize: 24, fontFamily: "Prompt", fontWeight: "bold", BackGround:"lime" }}>
          เริ่มเดิน <span style={{ fontSize: 24, fontFamily: "Prompt", fontWeight: "bold" }}>คุณเหลือเวลาอีก</span>
        </p>
        <p style={{ fontSize: 32, fontFamily: "Prompt", fontWeight: "bold" }}>
          {countdown}
        </p>
      </>
    )}
    ...
    <canvas
      ...
      // คงอยู่ตลอด ใช้ visibility แทน display เพื่อไม่ให้ unmount
      style={{ visibility: startTriggered ? "visible" : "hidden" }}
    />
