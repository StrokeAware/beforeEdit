  ...
  return (
    <div>
      ...
      <div className="banner1-1">
        <div
          className="banner-content align-items-center justify-content-between"
          style={{ width: "100%" }}
        >
          ...
          <button
            type="button"
            className="btn d-flex justify-content-center justify-content-center rounded-pill border-0 fw-bold ms-3"
            style={{
