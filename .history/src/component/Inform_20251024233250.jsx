        ...
        <div className="row flex-grow-1 w-100 align-items-center">
          ...
          <div className="col-12 col-lg-7 d-flex flex-column justify-content-center">
            ...
            <h4
              ...
              style={{ color: "#166989", fontSize: "clamp(0.9rem, 2vw, 3rem)" }}
            >
          ...
          {/* ฝั่งขวา */}
          <div className="col-12 col-lg-5 text-lg-end d-flex flex-column justify-content-center " style={{ marginTop: "-10vw" }}>
            <div
              className="fw-bold"
