    ...
    <div>
      ...
      <div className="banner1-1">
        <div className="banner-content">
          ...
          <button
              type="button"
              className="btn  d-flex flex-column align-items-center justify-content-center rounded-pill py-2 px-4 mt-3"
              style={{ width: "clamp(0.2rem, 8vw, 20rem)", height: "clamp(0.2rem, 4vw, 20rem)" ,background: "#616edf"}}
              onClick={() => navigate("/PatientDetail")}
            >
              <span
                className="fw-semibold text-white justify-content-center "
                style={{
