...
export function BEFAST_MAIN_Detail() {
  ...
  const imgStyle = { display: 'block', width: "clamp(10rem, 20vw, 40rem)", height: "clamp(10rem, 18vw, 40rem)", marginTop: '7vw', marginLeft: "4vw", position: "fixed",backgroundColor: "#ff0000ff", };
