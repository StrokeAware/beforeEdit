                ...
                <div key={q.id} style={{ marginBottom: 16 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <input
                      id={`ans-${index}`}
                      type="text"
                      placeholder={a.none ? '' : t('placehold')}   // no placeholder when disabled
                      className="BTN-02"
                      value={a.text}
                      disabled={a.none}
                      onChange={(e) => handleTextChange(index, e.target.value)}
                      aria-labelledby={`q-${index}`}               // tie to the question text element
                      autoComplete="off"
                      inputMode="text"                             // or "numeric" if numbers
                    />
