  ...
  return (
    <div>
      ...
      <div className="banner1-1">
        {/* ชั้นนี้คือกล่อง "ข้อความ + ปุ่ม" */}
        <div
          className="banner-content d-flex align-items-center justify-content-center"
          style={{
            width: "100%",
            marginTop: "6vw",        // ดันลงมาจากด้านบนของรูปให้ดูกลางภาพ
            padding: "0 2rem",       // กันไม่ให้ติดขอบซ้ายขวาเกินไป
            textAlign: "center",
          }}
        >
          {/* ข้อความสองบรรทัด */}
          <div
            className="bannerforcon text-center me-3"
            style={{
              lineHeight: 1.4,
              maxWidth: "60rem",     // บังคับไม่ให้ข้อความยาวเต็มจอจนแตก layout
              color: "white",
            }}
          >
            <div
          ...
          <button
            type="button"
            className="btn d-flex align-items-center justify-content-center rounded-pill border-0 fw-bold shadow"
            style={{
