...
// ------------------------------------
 ...
 const assessmentbtn = [
  ...
  <div
    className="banner-content d-flex flex-column align-items-end justify-content-center text-end pe-md-5 pe-lg-5"
    style={{
      width: "100%",
      height: "100%",
      color: "white",
  ...
  >
    {/* กล่องข้อความ */}
    <div className="bannerforcon lh-sm mb-3">
      <h2
        className="infor1-firstpic fw-semibold mb-2"
        style={{
      ...
      >
        แพลตฟอร์มคัดกรองโรคหลอดเลือดสมองนอกโรงพยาบาลแบบเชิงรุก ด้วยเทคนิค ASIS
      </h2>

      <p
        className="infor3-firstpic mb-0"
        style={{
    ...
    <button
      type="button"
      className="btn btn-primary rounded-pill border-0 fw-bold shadow px-4 py-2"
      style={{
