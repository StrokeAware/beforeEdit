...
export function BEFAST_MAIN_Detail() {
  ...
  const questions = [
    { id: 'question1', text: t("questions.question1") },
    { id: 'question2', text: t("questions.question2") },
    { id: 'question3', text: t("questions.question3") },
    { id: 'question4', text: t("questions.question4") },
    { id: 'question5', text: t("questions.question5") },
    { id: 'question6', text: t("questions.question6") },
  ];
