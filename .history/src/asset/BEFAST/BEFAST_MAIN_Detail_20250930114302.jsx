...
export function BEFAST_MAIN_Detail() {
  ...
  const left  = { width: "clamp(15rem, 25vw, 30rem)" };
  const right = { flex: 1, position: "relative", alignSelf: "flex-start" };
  const nextBtn = {
    position: 'relative',
    zIndex: 9999,
    display: 'inline-flex',
  ...
  const imgStyle = { display: 'block', width: "clamp(10rem , 20vw, 40rem)", height: "clamp(10rem , 20vw, 40rem)", marginTop: '10vw', marginLeft:"10vw" ,backgroundColor: "rgba(255, 0, 0, 1)",};
